...
namespace Tournaments
{
    ...
    public partial class PlayerManager : MvpPage<PlayerViewModel>, IPlayerView
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.EnableGridViewButtions(this.GridViewPlayers, String.Empty);
        }
        ...
        public IQueryable<Player> GridViewPlayers_GetData()
        {
        ...
        public void GridViewPlayers_InsertItem()
        {
        ...
        // The id parameter name should match the DataKeyNames value set on the control
        public void GridViewPlayers_UpdateItem(int? id)
        {
